            ...
            <div class="row">
                <div class="col-lg-5 col-md-12 col-sm-12 footer-widget md-mb-50 position-relative">
                    ...
                    <div class="textwidget pr-60 md-pr-15">
                        <p class="m-0">&copy; 2023 ConceptToCreation All Rights Reserved. </p>
                    </div>
                </div>
                            ...
                            <ul class="footer_social">
                                <li>
                                    <a href="<?php echo $optionsList[3]->option_value?>" target="_blank">
                                        <span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="8.905" height="18.459" viewBox="0 0 8.905 18.459"><path id="facebook-svgrepo-com" d="M-331.513,276.951c0-.743.663-1.009,1.406-1.009a6.4,6.4,0,0,1,1.536.231l.476-2.827a11.856,11.856,0,0,0-3.418-.346,3.4,3.4,0,0,0-2.964,1.392,5,5,0,0,0-.613,2.863v1.853H-337v2.762h1.911v9.59h3.576v-9.59h2.834l.209-2.762h-3.043Z" transform="translate(337 -273)" fill="#186aff"/></svg>
                                        </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo $optionsList[2]->option_value?>" target="_blank">
                                        <span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20.154" height="16.378" viewBox="0 0 20.154 16.378"><path id="Icon_metro-twitter" data-name="Icon metro-twitter" d="M22.724,6.756a8.267,8.267,0,0,1-2.375.651A4.147,4.147,0,0,0,22.168,5.12a8.278,8.278,0,0,1-2.626,1A4.139,4.139,0,0,0,12.5,9.894a11.739,11.739,0,0,1-8.522-4.32,4.139,4.139,0,0,0,1.28,5.52,4.118,4.118,0,0,1-1.873-.517c0,.017,0,.035,0,.052A4.137,4.137,0,0,0,6.7,14.684a4.142,4.142,0,0,1-1.867.071,4.139,4.139,0,0,0,3.862,2.871A8.3,8.3,0,0,1,3.557,19.4a8.386,8.386,0,0,1-.986-.058A11.7,11.7,0,0,0,8.909,21.2,11.684,11.684,0,0,0,20.673,9.431q0-.269-.012-.535a8.4,8.4,0,0,0,2.063-2.14Z" transform="translate(-2.571 -4.817)" fill="#186aff"/></svg>
                                        </span>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="<?php echo $optionsList[16]->option_value?>" target="_blank">
                                        <span>
                                            <svg id="Group_63" data-name="Group 63" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18.492" height="18.459" viewBox="0 0 18.492 18.459"><defs><clipPath id="clip-path"><rect id="Rectangle_134" data-name="Rectangle 134" width="18.492" height="18.459" fill="#186aff"/></clipPath></defs><rect id="Rectangle_133" data-name="Rectangle 133" width="3.837" height="12.325" transform="translate(0.306 6.134)" fill="#186aff"/><g id="Group_36" data-name="Group 36" transform="translate(0 0)"><g id="Group_35" data-name="Group 35" clip-path="url(#clip-path)"><path id="Path_2983" data-name="Path 2983" d="M2.222,0h0A2.221,2.221,0,1,0,4.442,2.22,2.219,2.219,0,0,0,2.22,0" transform="translate(0 0)" fill="#186aff"/><path id="Path_2984" data-name="Path 2984" d="M9.116,8.549h.006v0Z" transform="translate(-2.576 -2.415)" fill="#186aff"/><path id="Path_2985" data-name="Path 2985" d="M16.474,8.124a4.029,4.029,0,0,0-3.632,1.99h-.051V8.43H9.123V20.752H12.95v-6.1c0-1.606.307-3.164,2.3-3.164,1.965,0,1.991,1.84,1.991,3.269v5.995H21.07v-6.76c0-3.318-.716-5.871-4.6-5.871" transform="translate(-2.578 -2.296)" fill="#186aff"/></g></g></svg>
                                        </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo $optionsList[18]->option_value?>" target="_blank">
                                        <span>
                                            <svg id="Instagram-Glyph-Color-Logo.wine" xmlns="http://www.w3.org/2000/svg" width="18.459" height="18.459" viewBox="0 0 18.459 18.459">
                                                ...
                                                <path id="Path_2980" data-name="Path 2980" d="M4.8-20a3.075,3.075,0,0,1-3.076-3.074A3.077,3.077,0,0,1,4.8-26.153a3.079,3.079,0,0,1,3.078,3.078A3.077,3.077,0,0,1,4.8-20Zm0-7.816A4.74,4.74,0,0,0,.06-23.075,4.738,4.738,0,0,0,4.8-18.337a4.74,4.74,0,0,0,4.74-4.738A4.742,4.742,0,0,0,4.8-27.817Z" transform="translate(4.431 32.306)" fill="#186aff"/></svg>
                                        </span>
                                    </a>
                                </li>
                            </ul>
        ...
        <div class="container">
            <div class="row y-middle">
                <div class="col-lg-12 md-mb-20 text-center">
                    <div class="copyright">
                        <p>&copy; 2023 ConceptToCreation All Rights Reserved. </p>
                    </div>
                </div>
            </div>
        </div>
