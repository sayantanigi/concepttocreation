          ...
          <table class="table table-bordered2 table-striped">
            ...
            <tbody>
              ...
              ?>
                  <tr>
                    <td><?= $i ?></td>
                    <td><?php if(!empty($crsnm->name)) { echo $crsnm->name; } else { echo"&#8212;"; } ?></td>
                    <td><?php if(!empty($course_v->material_type)) { echo $course_v->material_type; } else { echo"&#8212;"; } ?></td>
                    <td>
                      <?php 
                    ...
                    <td>
                      <div class="truncate_desc">
                        ...
                        ?>
                          <div><?=$k?>. <a href="<?php echo base_url('uploads/materials/'.@$file->resource_file) ?>" target="__blank" title="Download"><?php echo @$file->resource_file ?></a></div>
                        <?php $k++; } } ?>
                      </div>
                      <div class="truncate_desc"><?php if(!empty(@$course_v->material_description)) { echo html_entity_decode(@$course_v->material_description); } else { echo"&#8212;"; } ?></div>
                    </td>
                    <td>
