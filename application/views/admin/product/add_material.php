  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form action="<?= admin_url('course/save_materials/' . $crsid) ?>" method="post" id="form_validation" enctype="multipart/form-data">
          <div class="box-body">
            <div class="container">
              <div class="row">
                <!-- <h3>Step One....</h3> -->
              ...
              <div class="row">
                ...
                <div class="col-sm-10">
                  <div class="box-footer">
                    <button type="submit" class="btn btn-primary" name="submit" value="addMaterials">Submit</button>
                  </div>
                </div>
              </div>
            </div>
