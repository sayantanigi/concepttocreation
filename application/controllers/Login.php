    ...
    public function index()
    {
        ...
        if ($this->input->post('username')) {
            ...
            if ($this->form_validation->run() == false) {
                ...
                $data['msg'] = '<div class="alert alert-warning alert-dismissable">
                ...
                $data['msg'] = '<div class="alert alert-warning alert-dismissable">
                    ...
                    '.$this->usermodel->userLogin($username, $password).'
                </div>';
                if ($this->session->has_userdata('user_id') && $this->session->has_userdata('users')) {
         ...
         if($f == 0){
            echo '<div class="alert alert-danger alert-dismissable">
                     ...
                     echo '<div class="alert alert-danger alert-dismissable">
                        ...
                        Your account has been deactivated. Please contact master admin for details.
                    </div>';
                }elseif ($f == 3) {
                     echo '<div class="alert alert-danger alert-dismissable">
                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                        ...
                        Permission denied. Please contact master admin!
                    </div>';
                }
                elseif ($f == 1) {
            ...
            if ($update) {
                     ...
                     $message="$otp use otp for changing condoadmin password";$message='<body style="background:#2a2a2a;font-family: sans-serif;">
                    <div style="text-align: center;width: 45%; margin: 0 auto; background: #fff;">
                    <img src="'.base_url('images/logo-black.png').'" alt="" style="width: 100px;margin-top: 10px;">
                    <div style="margin-top: 30px;">
                    <h2>Welcome to <a style="color: #39b54a;">Condo Admin!</a></h2>
                    </div>
                    <div style="margin-top: 30px;">
                    <p> '.$msg.'</p>
                    </div>
                    <div style="margin-top: 30px;">
                    <h3 style="color: #3a3a3a;font-weight: 500;font-size: 22px;">Please <a href="'.base_url().'" style="color: #39b54a;text-decoration: none;">login</a> to your acoount</h3>
                    </div>
                    
                    <div style="width: 50%;border-bottom: 2px solid #39b54a;padding: 40px 0px;margin: 0 auto;">
                    <p style="margin: 0;font-weight: 600;color: #3a3a3a;">Sincerly,</p>
                    <p style="margin: 0;margin-top: 5px;font-weight: 600;color: #3a3a3a;">The CondoAdmin Team</p>
                    </div>
                    <div style="margin-top: 40px;">
                    <h2><a style="color: #39b54a;">Condo Living</a> Made Easy</h2>
                    </div>
                    <div style="margin-top: 20px; padding-bottom: 20px;">
                    <p style="font-size:15px;">© 2022 CondoAdmin Canada | <a href="" style="color: #000;text-decoration: none;">Terms and Conditions</a> | <a href="" style="color: #000;text-decoration: none;">Privacy Policy</a></p>
                    </div>
                    </div>
                    </body>';
                ...
                try {
                    //Server settings
                    $mail->CharSet = 'UTF-8';
                    $mail->SetFrom('no-reply@condoadmin.ca','Condo Admin');
                    ...
                    $mail->Username   = "no-reply@condoadmin.ca";
    ...
    public function editusrPassword()
    {
        if ($this->input->post('otp')) {
            ...
            $msg = '<div class="alert alert-danger alert-dismissable">
                       ...
                       Plese insert valid OTP and Email Id.
                    </div>';
            }
