...
class Users extends CI_Controller {
	...
	public function profileUpdate() {
		if ($this->input->post('submit')) {
			...
			$where = array('id' => @$user_id);
			$mydata = array('fname' => $first_name, 'lname' => $last_name, 'email' => $email, 'phone' => $this->input->post('phone'), 'phone_full' => $phone_full, 'phone_code' => $phone_code, 'phone_country' => $phone_country, 'phone_st_country' => $phone_st_country, 'user_bio' => $this->testInput($this->input->post('user_bio')),
            );
